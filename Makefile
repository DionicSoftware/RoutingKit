...
lib/libroutingkit.a: build/unity_logger.o build/routingkit_wrapper.o build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/strongly_connected_component.o build/timer.o build/vector_io.o
	@mkdir -p lib
	$(AR) rcs lib/libroutingkit.a build/unity_logger.o build/routingkit_wrapper.o build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/strongly_connected_component.o build/timer.o build/vector_io.o

lib/libroutingkit.so: build/unity_logger.o build/routingkit_wrapper.o build/bit_vector.o build/contraction_hierarchy.o build/timer.o build/graph_util.o
	@mkdir -p lib
	$(CC) -shared $(LDFLAGS) build/unity_logger.o build/routingkit_wrapper.o build/bit_vector.o build/contraction_hierarchy.o build/timer.o build/graph_util.o $(OMP_LDFLAGS) -lm -lz -pthread -o lib/libroutingkit.so
